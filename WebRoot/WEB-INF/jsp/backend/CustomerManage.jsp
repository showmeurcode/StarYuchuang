                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <c:forEach var="adminUserList" items="${adminUserList}">
                                        <tr>
                                            ...
                                            <td>${adminUserList.id}</td>
                                            <td>${adminUserList.adminName}</td>
...
<script>
    ...
    function del(id) {
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/adminuser/deleteuser",
                data: {
                    "id": id
   ...
   //修改用户信息
    ...
    function AddUser() {
        ...
        layer.open({
            ...
            shadeClose : false, //点击遮罩关闭层
            area : [ '800px', '550px' ],
            content : '${pageContext.request.contextPath}/adminuser/adduser',
            end: function(){
                var table = $('.dataTables-example').DataTable();
                table.draw( false );
            }
