        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <button type="button" id="loading-example-btn" class="btn btn-success btn-sm" onclick="AddType()" ><i class="fa fa-spinner" aria-hidden="true"></i> 新增分类</button>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align:center; width:70%;">分类名称</th>
                                        <th style="text-align:center; width:20%;">操作</th>

                                    </tr>
                                    </thead>
                                    <tbody style="text-align:center;">
                                    <c:forEach var="newsclassify" items="${newsClassifyList}">

                                        <tr>
                                            <td>${newsclassify.id}</td>
                                            <td>${newsclassify.name}</td>
                                            <td><a class="btn btn-primary btn-sm" href="#" onclick="edittype('${newsclassify.id}')">&#x7F16;&#x8F91;</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-danger btn-sm" href="#" onclick="del('${newsclassify.id}')">&#x5220;&#x9664;</a></td>
                                        </tr>
...
<script>
    ...
    function del(sid) {
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/newsClassify/delClassify",
                data: {
                    "id": sid
...
<script>
    ...
    function edittype(sid) {
        ...
        layer.open({
            ...
            area : [ '600px', '260px' ],
            content : ['${pageContext.request.contextPath}/newsClassify/update?id=' + sid,'no'],
            end: function(){
                var table = $('.dataTables-example').DataTable();
                table.draw( false );
            }
    ...
    function AddType() {
        layer.open({
            ...
            shadeClose : false, //点击遮罩关闭层
            area : [ '600px', '260px' ],
            content : '${pageContext.request.contextPath}/newsClassify/add',
            end: function(){
                var table = $('.dataTables-example').DataTable();
                table.draw( false );
            }
