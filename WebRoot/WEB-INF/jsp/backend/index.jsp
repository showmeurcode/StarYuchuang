        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="${pageContext.request.contextPath}/basicsetting/findBasicsetting" ondragstart="return false">网站基础设置</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="${pageContext.request.contextPath}/linkmanager/findLinkmanager" ondragstart="return false">友情链接管理</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="${pageContext.request.contextPath}/singlepageReservations/findSinglepageReservations" ondragstart="return false">预约报名</a>
                    </ul>
                </li>
                <li>
