...
<script>
    ...
    function del(sid) {
        swal({
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/singlepageReservations/delSinglepageReservationsg",
                data: {
                    "id": sid
...
<script>
    ...
    function AddType() {
        layer.open({
            ...
            shadeClose : false, //点击遮罩关闭层
            area : [ '600px', '260px' ],
            content : '${pageContext.request.contextPath}/singlepageReservations/addshowSing',
            end: function(){
                var table = $('.dataTables-example').DataTable();
                table.draw( false );
            }
