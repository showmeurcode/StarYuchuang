        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <button type="button" id="loading-example-btn" class="btn btn-success btn-sm" onclick="AddType()" ><i class="fa fa-spinner" aria-hidden="true"></i> 新增链接</button>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align:center; width:70%;">网站名称</th>
                                        <th style="text-align:center; width:20%;">操作</th>

                                    </tr>
                                    </thead>
                                    <tbody style="text-align:center;">
                                    <c:forEach var="res" items="${linkmanagerList}">
                                        <tr>
                                            <td>${res.id}</td>
                                            <td>${res.name}</td>
...
<script>
    ...
    function edittype(sid) {
        ...
        layer.open({
            ...
            area : [ '600px', '260px' ],
            content : ['${pageContext.request.contextPath}/linkmanager/updateLink?id=' + sid,'no'],
            end: function(){
                var table = $('.dataTables-example').DataTable();
                table.draw( false );
            }
