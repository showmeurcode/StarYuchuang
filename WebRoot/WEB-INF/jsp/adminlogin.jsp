    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <form action="${pageContext.request.contextPath}/adminuser/Blogin" method="post" >
                ...
                <div>
                    <input type="text" name="adminName" class="form-control uname"value="${adminUser.adminName}" placeholder="用户名" required=""/>
                </div>
                <div>
                    <input type="password" name="adminPassword" class="form-control pword m-b" value="${adminUser.adminPassword}" placeholder="密码" required=""/>
                </div>
                <a href="#">忘记密码了？</a>
